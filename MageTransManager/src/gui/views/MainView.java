...
public class MainView extends javax.swing.JFrame {
    ...
    public MainView() {
    	...
    	setIconImage(Toolkit.getDefaultToolkit().getImage(MainView.class.getResource("/res/icon_translations.png")));
	...
	private void initComponents() {
        ...
        mItem_settings.setIcon(new ImageIcon(MainView.class.getResource("/res/icon_settings.png")));
        ...
        mItem_search.setIcon(new ImageIcon(MainView.class.getResource("/res/icon_search.png")));
        mItem_exit = new javax.swing.JMenuItem();
        mItem_exit.setIcon(new ImageIcon(MainView.class.getResource("/res/icon_shut-down.png")));
        ...
        jMenu2.setIcon(new ImageIcon(MainView.class.getResource("/res/icon_translations.png")));
        jMenuItem10 = new javax.swing.JMenuItem();
        jMenu7 = new javax.swing.JMenu();
        jMenu7.setIcon(new ImageIcon(MainView.class.getResource("/res/icon_database.png")));
        mItem_langVersions = new javax.swing.JMenuItem();
        ...
        jMenuItem13.setIcon(new ImageIcon(MainView.class.getResource("/res/icon_user-edit.png")));
        jMenuItem12 = new javax.swing.JMenuItem();
        jMenuItem12.setIcon(new ImageIcon(MainView.class.getResource("/res/icon_user-groups.png")));
        ...
        jMenuItem4.setIcon(new ImageIcon(MainView.class.getResource("/res/icon_user-teams.png")));
        jMenu4 = new javax.swing.JMenu();
        jMenu4.setIcon(new ImageIcon(MainView.class.getResource("/res/icon_view.png")));
        ...
        tbl_trans.setSelectionBackground(Color.DARK_GRAY);
        ...
        tbl_trans.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
                ...
                tbl_trans.setModel(new javax.swing.table.DefaultTableModel(
                    new Object [][] {
                        {"btn_basket", "Warenkorb", ""},
                        {"txt_agb", "agb_de.pdf", "agb_it.pdf"},
                        {null, null, null},
                        {null, null, null},
                        {null, null, null},
                        {null, null, null},
                        ...
                        pnl_btnBar.setBackground(UIManager.getColor("Panel.background"));
                                ...
                                jButton4.setText("Edit");
                                        ...
                                        jButton5.setText("(De)Activate");
                                                ...
                                                btnSearch.setIcon(new ImageIcon(MainView.class.getResource("/res/icon_search.png")));
        ...
        jMenu2.setText("Translations");

        jMenuItem10.setText("Categories");
        jMenu2.add(jMenuItem10);

        jMenu8.add(jMenu2);

        jMenu7.setText("Data Structure");

        mItem_langVersions.setText("Language Versions");
        mItem_langVersions.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                openDbEditorView();
            }
        });
        jMenu7.add(mItem_langVersions);
        ...
        mnHelp.setIcon(new ImageIcon(MainView.class.getResource("/res/icon_info.png")));
    ...
    private javax.swing.JMenuItem mItem_langVersions;
